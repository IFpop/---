...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.start.setGeometry(QtCore.QRect(500, 340, 93, 28))
        self.start.setObjectName("start")
        self.Next = QtWidgets.QPushButton(self.centralwidget)
        self.Next.setGeometry(QtCore.QRect(620, 380, 93, 28))
        self.Next.setObjectName("Next")
        self.Last = QtWidgets.QPushButton(self.centralwidget)
        self.Last.setGeometry(QtCore.QRect(500, 380, 93, 28))
        self.Last.setObjectName("Last")
        self.Done = QtWidgets.QPushButton(self.centralwidget)
        self.Done.setGeometry(QtCore.QRect(620, 340, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Last.setText(_translate("MainWindow", "PushButton"))
        self.Done.setText(_translate("MainWindow", "PushButton"))
